...
export default async function Home() {
  ...
  return (
    <div className="relative min-h-full flex-1 overflow-hidden bg-ink-bg font-editorial text-ink-text">
      ...
      <div className="relative mx-auto grid w-full max-w-[1180px] grid-cols-1 items-center gap-10 px-6 py-16 sm:px-12 sm:py-20 md:grid-cols-[1.15fr_0.85fr] md:gap-8">
